...
The specifics of altering your Python environments in Terminal/Gitbash will depend on your initial Anaconda installation (location/directory and options)  and the directory/level on which you Gitbash.
